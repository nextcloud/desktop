...
if(WIN32)
    ...
    set( CFAPI_SHELLEXT_COMMAND_HANDLER_CLASS_ID   "B28BEFF4-6B76-4463-9596-C1546D2BBBDF" )
    set( CFAPI_SHELLEXT_COMMAND_HANDLER_CLASS_ID_REG "{${CFAPI_SHELLEXT_COMMAND_HANDLER_CLASS_ID}}" )
    set( CFAPI_SHELLEXT_COMMAND_HANDLER_DISPLAY_NAME   "${APPLICATION_NAME} Command Handler" )

    # CustomStateHandler
    set( CFAPI_SHELLEXT_CUSTOM_STATE_HANDLER_CLASS_ID   "D44F9EE2-0819-4ACD-918D-EF89D6D7BF45" )
