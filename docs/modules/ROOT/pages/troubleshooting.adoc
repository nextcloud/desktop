...
On Linux and Mac simply open the terminal and run `owncloud`.
...
Make sure to adjust the path to your `owncloud.exe`, if you have chosen to install the client in a different path
