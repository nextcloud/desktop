...
* Windows 7+ (Stable WinVFS available for Windows 10 version 1709 or later)
* macOS 10.12+ (unsupported legacy builds for Mac OS X 10.10 & 10.11 available; 64-bit only)
* CentOS 7.6+ & 8
* Debian 9.0 & 10
* Fedora 30 & 31 & 32
