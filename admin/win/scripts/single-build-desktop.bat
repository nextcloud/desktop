...
echo "cmake "-G%CMAKE_GENERATOR%" -S "%DESKTOP_REPO_PATH%" -DMIRALL_VERSION_SUFFIX="%VERSION_SUFFIX%" -DBUILD_TESTING="OFF" -DWITH_CRASHREPORTER="OFF" -DBUILD_UPDATER="%BUILD_UPDATER%" -DBUILD_WIN_MSI="%BUILD_INSTALLER_MSI%" -DMIRALL_VERSION_BUILD="%BUILD_DATE%" -DCMAKE_INSTALL_PREFIX="%MY_INSTALL_PATH%" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_PREFIX_PATH="%CRAFT_PATH%" -DPng2Ico_EXECUTABLE="%Png2Ico_EXECUTABLE%" -DWIX_SDK_PATH="%WIX_SDK_PATH%""
start "cmake.." /D "%MY_BUILD_PATH%" /B /wait cmake "-G%CMAKE_GENERATOR%" -S "%DESKTOP_REPO_PATH%" -DMIRALL_VERSION_SUFFIX="%VERSION_SUFFIX%" -DBUILD_TESTING="OFF" -DWITH_CRASHREPORTER="OFF" -DBUILD_UPDATER="%BUILD_UPDATER%" -DBUILD_WIN_MSI="%BUILD_INSTALLER_MSI%" -DMIRALL_VERSION_BUILD="%BUILD_DATE%" -DCMAKE_INSTALL_PREFIX="%MY_INSTALL_PATH%" -DCMAKE_BUILD_TYPE="%BUILD_TYPE%" -DCMAKE_PREFIX_PATH="%CRAFT_PATH%" -DPng2Ico_EXECUTABLE="%Png2Ico_EXECUTABLE%" -DWIX_SDK_PATH="%WIX_SDK_PATH%"
if %ERRORLEVEL% neq 0 goto onError
