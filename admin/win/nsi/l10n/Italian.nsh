...
StrCpy $ConfirmEndProcess_KILLING_PROCESSES_TEXT "Terminando i processi ${processName}."
...
StrCpy $PageReinstall_OLD_Field_1 "Una versione più recente di ${APPLICATION_NAME} è già installata! Non è consigliabile installare una versione più vecchia. Se vuoi veramente installare una versione più vecchia, è consigliato rimuovere prima la versione corrente. Scegli l'operazione da fare e clicca Prossimo per continuare."
...
StrCpy $UAC_INSTALLER_REQUIRE_ADMIN "Il programma di installazione necessita le credenziali di amministratore, riprova"
StrCpy $INIT_INSTALLER_RUNNING "Il programma di installazione è già in esecuzione"
StrCpy $UAC_UNINSTALLER_REQUIRE_ADMIN "Il programma di disinstallazione necessita le credenziali di amministratore, riprova"
StrCpy $INIT_UNINSTALLER_RUNNING "Il programma di disinstallazione è già in esecuzione."
StrCpy $SectionGroup_Shortcuts "Collegamenti"
