...
StrCpy $UNINSTALLER_APPDATA_SUBTITLE "Usuñ folder z danymi ${APPLICATION_NAME} z komputera."
StrCpy $UNINSTALLER_APPDATA_LABEL_1 "Czy chcesz usun¹æ folder z danymi ${APPLICATION_NAME}?"
StrCpy $UNINSTALLER_APPDATA_LABEL_2 "Zostaw niezaznaczone aby zachowaæ folder z danymi lub zaznacz aby go usun¹æ."
StrCpy $UNINSTALLER_APPDATA_CHECKBOX "Tak, usuñ folder z danymi."
