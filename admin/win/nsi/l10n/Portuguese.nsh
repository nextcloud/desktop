...
StrCpy $ConfirmEndProcess_MESSAGEBOX_TEXT "Encontrados ${APPLICATION_EXECUTABLE} processo(s) em execução que precisa(m) de set interrompido(s).$\nDeseja que o instalador o(s) determine por si?"
...
StrCpy $PageReinstall_NEW_Field_1 "Está instalada no sistema uma versão antiga de ${APPLICATION_NAME}. É recomendado que desinstale a versão actual antes de instalar a mais recente. Selecione a operação que deseja executar e clique em $\"Seguinte$\" para continuar."
...
StrCpy $PageReinstall_SAME_Field_2 "Adicionar/Reinstalar Components"
...
StrCpy $SEC_APPLICATION_DETAILS "A instalar o essential de ${APPLICATION_NAME}."
...
StrCpy $OPTION_SECTION_SC_APPLICATION_Desc "O essential de ${APPLICATION_NAME}."
...
StrCpy $UAC_ERROR_ELEVATE "Incapaz de elevar, error:"
