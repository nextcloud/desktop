...
StrCpy $PageReinstall_SAME_Field_1 "Program ${APPLICATION_NAME} ${VERSION} je že namešèen.$\n$\nIzberite opravilo, ki ga želite izvesti in kliknite za nadaljevanje."
...
StrCpy $OPTION_SECTION_SC_SHELL_EXT_DetailPrint "Namešèanje podpore za program Windows Raziskovalec"
