...
2. **Jede neue Datei erklärt:** alle 7 (`FileDetailsPage.qml`, `main.cpp`, `ActivityItem.qml`, `IconButton.qml`, `SecondaryPillButton.qml`, `TrayFolderListItem.qml`, `TrayFoldersMenuButton.qml`) gehen ausschließlich auf einen einzigen Commit zurück: `70a6a94dd` "SES-596 fix undefined font fallback on Linux/macOS" — nicht auf eine Merge-Konfliktauflösung.
...
### Neu seit dem Merge: ActivityItem.qml / IconButton.qml / SecondaryPillButton.qml / TrayFolderListItem.qml / TrayFoldersMenuButton.qml
