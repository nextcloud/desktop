...
///
/// Passthrough ``RemoteInterface`` that forwards every call and records how many requests the code
/// under measurement issued and how many were in flight at once.
///
