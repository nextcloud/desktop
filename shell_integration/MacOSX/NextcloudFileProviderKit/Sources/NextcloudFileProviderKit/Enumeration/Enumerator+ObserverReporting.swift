        ...
        Task { [updated, deletedToRemove] in
            do {
                ...
                Task { @MainActor in
                    ...
                    //
                    // One transaction for the batch, not one per item, because this block runs on
                    // the main actor and per-item writes put the whole batch's Realm work in front
                    // of everything else scheduled there.
