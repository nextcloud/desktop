...
struct FileProviderDomainDefaults {
    ///
    /// > Warning: Do not change the raw values of these keys, as they are used in UserDefaults.
    ///
    ...
    var trashDeletionEnabled: Bool {
        ...
        set {
            ...
            Logger.fileProviderDomainDefaults.error("Attempt to set an empty string as the value for \"trashDeletionEnabled\" for file provider domain \"\(identifier)\"!")
