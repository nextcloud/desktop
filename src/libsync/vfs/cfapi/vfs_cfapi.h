...
public:
    ...
    bool setPinState(const QString &folderPath, PinState state, const QString invoker) override;
    Optional<PinState> pinState(const QString &folderPath, const QString invoker) override;
