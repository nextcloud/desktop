...
void PropagateLocalRename::start()
{
    ...
    qCDebug(lcPropagateLocalRename()) << (FileSystem::fileExists(propagator()->fullLocalPath(_item->_originalFile)) ? "original file exists" : "orignal file is missing") << propagator()->fullLocalPath(_item->_originalFile) << _item->_originalFile;
    qCDebug(lcPropagateLocalRename()) << (FileSystem::fileExists(existingFile) ? "existing file exists" : "existing file is missing") << existingFile;
