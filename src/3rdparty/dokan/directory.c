...
DokanFillDirectoryInformation(FILE_INFORMATION_CLASS DirectoryInfo,
  ...
  case FileDirectoryInformation:
    ...
    break;
  case FileFullDirectoryInformation:
    DokanFillFullDirInfo((PFILE_FULL_DIR_INFORMATION)Buffer, FindData, Index, DokanInstance);
    break;
  case FileIdFullDirectoryInformation:
    DokanFillIdFullDirInfo((PFILE_ID_FULL_DIR_INFORMATION)Buffer, FindData, Index, DokanInstance);
    break;
  case FileNamesInformation:
    DokanFillNamesInfo((PFILE_NAMES_INFORMATION)Buffer, FindData, Index);
    break;
  case FileBothDirectoryInformation:
    DokanFillBothDirInfo((PFILE_BOTH_DIR_INFORMATION)Buffer, FindData, Index, DokanInstance);
    break;
  case FileIdBothDirectoryInformation:
    DokanFillIdBothDirInfo((PFILE_ID_BOTH_DIR_INFORMATION)Buffer, FindData, Index, DokanInstance);
    break;
  default:
    break;
  }
...
int DokanFillFileData(PWIN32_FIND_DATAW FindData,
...
BOOL DokanIsNameInExpression(LPCWSTR Expression, // matching pattern
