...
VOID DokanUseStdErr(BOOL Status);

VOID DokanDebugMode(BOOL Status);

BOOL DokanServiceInstall(LPCWSTR ServiceName, DWORD ServiceType,
                                  LPCWSTR ServiceFullPath);

BOOL DokanServiceDelete(LPCWSTR ServiceName);

BOOL DokanNetworkProviderInstall();

BOOL DokanNetworkProviderUninstall();
