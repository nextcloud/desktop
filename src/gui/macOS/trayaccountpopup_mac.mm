...
static BOOL labelLikelyClipsText(NSTextField *label, NSString *text, const CGFloat availableWidth)
{
...
static NSString *menuRowToolTipText(NSString *title, NSString *subtitle, NSString *dateTime)
{
...
static void setSharedToolTip(NSString *toolTip, NSArray *views)
{
    if (toolTip.length == 0) {
        return;
    }
