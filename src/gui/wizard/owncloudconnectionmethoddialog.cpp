...
OwncloudConnectionMethodDialog::OwncloudConnectionMethodDialog(QWidget *parent)
    : QDialog(parent,
        Qt::CustomizeWindowHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint | Qt::MSWindowsFixedSizeDialogHint)
    , ui(new Ui::OwncloudConnectionMethodDialog)
{
    ...
    connect(
        ui->btnClientSideTLS, &QAbstractButton::clicked, this, &OwncloudConnectionMethodDialog::returnClientSideTLS);
...
{
    ui->label->setText(tr("<html><head/><body><p>Failed to connect to the secure server address <em>%1</em>. How do "
                          "you wish to proceed?</p></body></html>")
