...
ToolButton {
    ...
    property color solidColor: undefined
    property color solidColorChecked: undefined
    ...
    Component {
        ...
        Rectangle {
            ...
            color: control.solidColor.valid ? (control.checked ? control.solidColorChecked : control.solidColor) : undefined
            Label {
                anchors.fill: parent
